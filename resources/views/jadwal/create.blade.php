    ...
    <div class="main-panel">
        ...
        <div class="content">
            ...
            <div class="form-group">
                ...
                <input type="text" name="hari" placeholder="Masukan Nama Kelas" class="form-control">
            </div>
            <div class="form-group">
                <label for="waktu">waktu</label>
                <input type="text" name="waktu" placeholder="Masukan Nama Kelas" class="form-control" required>
            </div>
            <div class="form-group">
